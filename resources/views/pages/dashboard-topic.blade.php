        ...
        <div class="col-10">
            <div class="card widget-order-activity">
                <div class="card-header d-md-flex justify-content-between align-items-center">
                    <h4 class="card-title font_size_1point5_rem">Mentions trends <span><i class="bx bx-info-circle" data-toggle="tooltip" title="" data-trigger="hover" data-original-title="Track trend of mentions around the topic"></i></span></h4>
