...
<section id="widgets-advance">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li
              ...
              <div class="list-left d-flex">
                ...
                <div class="list-content">
                  <span class="list-title">Julia's birthday on Monday, party arrangement</span>
            ...
            <div class="card-header border-bottom d-flex justify-content-between align-items-center">
              ...
              <ul class="list-inline d-flex mb-0">
                <li class="d-flex align-items-center mr-1">
                  ...
                  <div class="dropdown">
                    <div class="dropdown-toggle" role="button" id="dropdownMenuButton" data-toggle="dropdown"
                      aria-haspopup="true" aria-expanded="false">
                      <span class="cursor-pointer">Filter</span>
                    </div>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="javascript:;">My Tasks</a>
                      <a class="dropdown-item" href="javascript:;">Due this week</a>
                      <a class="dropdown-item" href="javascript:;">Due next week</a>
                      <a class="dropdown-item" href="javascript:;">Custom filter</a>
                    </div>
                  </div>
                </li>
                <li class="d-flex align-items-center">
                  <i class='bx bx-sort mr-50 font-medium-3 cursor-pointer'></i>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton2">
                      ...
                      <a class="dropdown-item" href="javascript:;">Alphabetical</a>
                      <a class="dropdown-item" href="javascript:;">Due Date</a>
                      <a class="dropdown-item" href="javascript:;">Assignee</a>
                    </div>
                  </div>
                </li>
              </ul>
  ...
  <div class="row">
        ...
        <div class="card-body">
          <ul class="timeline" style="height: 415px;">
            ...
            <li class="timeline-item timeline-icon-primary active">
              ...
              <p class="timeline-text">on <a href="JavaScript:void(0);">Project name</a></p>
              <div class="timeline-content">
                <img src="{{asset('images/icon/sketch.png')}}" alt="document" height="36" width="27" class="mr-50">Data
                Folder.sketch
              </div>
            </li>
            <li class="timeline-item timeline-icon-danger active">
              ...
              <p class="timeline-text">on <a href="JavaScript:void(0);">Project name</a></p>
              <div class="timeline-content">
                <img src="{{asset('images/icon/pdf.png')}}" alt="document" height="36" width="27" class="mr-50">Updated
                Docs.pdf
              </div>
            </li>
          ...
          <div class="card-header border-bottom p-0">
            <div class="media m-75">
              <a class="media-left" href="JavaScript:void(0);">
                <div class="avatar mr-75">
                  <img src="{{asset('images/portrait/small/avatar-s-2.jpg')}}" alt="avatar images" width="32"
                    height="32">
            ...
            <div class="heading-elements">
              <div class="dropdown my-auto">
                ...
                <span class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="JavaScript:void(0);"><i class="bx bx-user mr-75"></i>View Profile</a>
                  <a class="dropdown-item" href="JavaScript:void(0);"><i class="bx bx-trash mr-75"></i>Clear chat</a>
                  <a class="dropdown-item" href="JavaScript:void(0);"><i class="bx bx-link-external mr-75"></i>Export
                    chat</a>
                  <a class="dropdown-item" href="JavaScript:void(0);"><i class="bx bx-volume-mute mr-75"></i>Mute</a>
                  <a class="dropdown-item" href="JavaScript:void(0);"><i class="bx bx-block mr-75"></i>Block</a>
                </span>
              </div>
            </div>
          </div>
                  ...
                  <td>
                    <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                      <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                        ...
                        <img class="media-object rounded-circle" src="{{asset('images/portrait/small/avatar-s-6.jpg')}}"
                          alt="Avatar" height="30" width="30">
                      </li>
                      <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                        data-original-title="Elicia Rieske" class="avatar pull-up">
                        <img class="media-object rounded-circle" src="{{asset('images/portrait/small/avatar-s-7.jpg')}}"
                          alt="Avatar" height="30" width="30">
                      </li>
                      <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
                        data-original-title="Darcey Nooner" class="avatar pull-up">
                        <img class="media-object rounded-circle" src="{{asset('images/portrait/small/avatar-s-8.jpg')}}"
                          alt="Avatar" height="30" width="30">
                      </li>
                      <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom"
      ...
      <div class="card widget-overlay">
              ...
              <div class="d-flex justify-content-between">
                ...
                <div class="dropdown">
                  <button class="btn btn-outline-white dropdown-toggle" type="button" id="dropdownMenuButtonSec"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">2020</button>
        ...
        <div class="card widget-overlay-content mb-0">
          ...
          <div class="card-body px-0 pb-0">
            <ul class="nav nav-pills border-bottom justify-content-center mb-1" role="tablist">
                ...
                <div class="table-responsive">
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="pr-0">
                          <span class="text-bold-500 d-block">CryptoICO</span>
                          <small>CryptoICO By PIXINVENT</small>
                        </td>
                        <td>
                          <div class="badge badge-pill badge-light-danger">Pending</div>
                        </td>
    ...
    <!-- User widget Card & Weather Card Starts -->
    <div class="col-xl-4 col-md-12 weather-card">
      <div class="row">
        ...
        <!-- User Widget Ends -->
        <!-- Cloud Widget Starts -->
        <div class="col-xl-12 col-md-6 col-12 weather">
          <div class="card">
            <div class="card-header">
              <div>
                <h3 class="font-weight-normal mb-0">16&deg;C</h3>
            ...
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between">
                <div>
                  <p class="mb-0">Sicklerville, New Jersey</p>
    ...
    <!-- User widget Card & Weather Card Ends -->
  </div>
</section>
<!-- Widgets Advance End -->
