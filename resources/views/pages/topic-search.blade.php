      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-10 col-sm-10">
            <p>Select / un-select keywords or hashtags</p>
            <div class="row">
              <div class="col-12">
                <!-- basic Badges -->
        ...
        <div class="row">
          <div class="col-md-3 col-sm-3">
            <p>Sentiment type</p>
              <div class="form-group">
                <select class="select2-size-sm form-control" multiple="multiple" name="post_senti[]" id="post_senti">
          ...
          <div class="col-md-3 col-sm-3">
            <p>Select Data Source</p>
              <div class="form-group">
                <select class="select2-size-sm form-control" multiple="multiple" name="data_source[]" id="data_source">
          ...
          <div class="col-md-3 col-sm-3">
            <p>Filter by location</p>
              <div class="form-group">
                <select class="select2-size-sm form-control" multiple="multiple" name="data_location[]" id="data_location">
          ...
          <div class="col-md-3 col-sm-3">
            <p>Language</p>
              <div class="form-group">
                <select class="select2-size-sm form-control" multiple="multiple" name="data_lang[]" id="data_lang">
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-sm-8">
            <p>&nbsp;</p>
            <button type="button" class="btn mr-1 mb-1 btn-primary btn-sm">Search</button>
          </div>
        </div>
      </div>
