...
return [
    ...
    'defaultIndex' => env('ELASTICSEARCH_DEFAULTINDEX', 'd24_june_2020'),
    'DATA_FETCH_FROM_TIME' => env('DATA_FETCH_FROM_TIME', 'now-30d'),
    'DATA_FETCH_TO_TIME' => env('DATA_FETCH_TO_TIME', 'now'),
